...
urlpatterns = patterns('',
    ...
    url(r'^today',
        TodayArchiveView.as_view(model=Event, template_name='event_list.html',
            date_field='starts', allow_future=True, allow_empty=True)),

    url(r'^this_week',
        WeekArchiveView.as_view(model=Event, template_name='event_list.html',
        date_field='starts',
    ...
    url(r'^this_month',
        MonthArchiveView.as_view(model=Event, template_name='event_list.html',
        date_field='starts',
    ...
    url(r'^this_year',
        YearArchiveView.as_view(model=Event, template_name='event_list.html',
        date_field='starts',
        year=date.today().strftime("%Y"),
        allow_future=True,
        allow_empty=True)),
